...
pd = gmdistribution.fit(m(:,[2,3,5,8,6,9,4,7]),2);
...
for i = 1:numsample,
    ...
    lprob(i,2) = lprob(i,2) + log(pdf(pd,[m(i,2),m(i,3),m(i,5),m(i,8),m(i,6),m(i,9),m(i,4),m(i,7)]));
    %log(pdf(pd,[m(i,2),m(i,3),m(i,5),m(i,8),m(i,6),m(i,9),m(i,4),m(i,7)]));
